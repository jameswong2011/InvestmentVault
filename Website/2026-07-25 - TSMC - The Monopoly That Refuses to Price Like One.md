...
**The market has known for years that TSMC dominates leading-edge chipmaking. The case rests elsewhere: the dominance is running deliberately below its own capacity on price, a yield lead measured in tens of points converts into margin no competitor can bid away, and a share price at roughly the index multiple hands the next decade of AI demand to the buyer for free.**
...
Three observations challenge the template. TSMC's margins are produced by a yield gap that new capacity cannot close, because competitors cannot yet manufacture the product economically at any price. Its pricing beneath a visible shortage is restraint rather than weakness, an unexercised option the company spends in measured doses. And the demand curve underneath it points toward a roughly five-fold expansion over the next decade, while the multiple assumes growth effectively ends here.

Laniakea Partners looks for this configuration: a business the market fully recognises, still valued through the mechanics of a cycle it may no longer belong to.

## Yield is the product, and failed chips have no salvage value

A foundry sells working chips, not wafers. Every leading-edge wafer absorbs the same cost whether its chips function or not: the same EUV exposures, the same hundreds of process steps, the same months of cycle time. A failed die cannot be reworked, discounted or resold. It is scrapped. At a given wafer price, yield, the share of chips that work, is the margin.

That is what makes TSMC's lead over Intel, Samsung and the Chinese foundries an absolute advantage rather than a relative one. Every percentage point of yield above a competitor is a full point of saleable output at zero incremental cost, and every point below is fully-paid-for silicon in the scrap bin. The current gap runs to tens of points: at 2nm-class production, TSMC's N2 runs near 90% yield at maturity while Samsung's SF2 is estimated at 55–60%, below the 65–70% threshold at which a leading-edge line recovers its capital at all.
...
Samsung's discount is an illusion. The customer pays per working chip, and at current yields Samsung is the more expensive foundry at two-thirds the price. TSMC's premium is thus TSMC's share of a yield surplus that only TSMC creates, not a cost its customers bear, which is why undercutting cannot buy back share, and why the profit spread across the industry (TSMC at a 67.7% gross margin, SMIC at 20.1%, Samsung Foundry and Intel Foundry in losses) is simply the yield table restated in accounting form.
...
The shortage is not subtle: TSMC's N3 node runs above 100% effective utilisation in the second half of 2026, with AI taking roughly 60% of its output this year and an estimated 86% next. N2 sold out at launch. Nvidia pre-booked more than half of 2026 CoWoS advanced-packaging capacity at a 20% price increase, and C.C. Wei told investors in July that packaging capacity is "so tight that now it's limiting my customers' growth." Cleanrooms take about two years to build, so no supply response can arrive faster.
...
TSMC also captures more of each AI dollar over time. Wafer, advanced packaging, testing, HBM base dies and, from 2027, co-packaged optics stack toward roughly 40% of an Nvidia system's silicon bill of materials, against 15–18% in a typical foundry relationship. A five-fold demand curve thus translates to at least a five-fold TSMC AI revenue opportunity.

Set that demand curve against the price. At the time of writing the ADR trades near $407, about 23 times an estimated $17.50 of 2026 earnings: roughly the index multiple, and a discount to every monopoly analogue (ASML near 35 times, Visa near 28). An index multiple on a business growing above 40% with 68% gross margins and a 46% return on equity is an explicit forecast that these earnings do not compound. The market's own behaviour states it plainly: earnings our internal work modelled two years ago as a 2028 bull case (~$16–17 per share) are landing in 2026, two years early, and the market's response was an 11% de-rate against rising estimates. Growth arrived ahead of schedule and was assigned a negative price, the arithmetic of a market treating incremental AI earnings as borrowed from the future rather than added to it.

That sets a low hurdle. If growth truly stops, the buyer owns the most profitable manufacturer on earth at the market multiple, with a dividend just raised by a third. If the five-fold path is even directionally right and TSMC holds its share and content, earnings compound in the mid-teens for a decade and the shareholder return approximates that compounding at an unchanged multiple. Zero growth is priced; everything above zero is free.
...
The demand falsifier is the second derivative of hyperscaler capex. If AI spending decelerates before the new capacity fills (TSMC's HPC revenue growing below 10% in any 2027 quarter would be the marker), the record capex becomes the overhang the bears already price. The five-fold curve also bends if software efficiency starts shrinking total silicon consumed rather than expanding workloads. The observable is aggregate leading-edge wafer consumption, not any single model's requirements.

Taiwan stands apart from all of these: a binary, not a data series. More than 95% of leading-edge capacity remains physically in Taiwan through 2028, and our scenario work puts invasion or blockade at 85–95% permanent impairment, far beyond the discount embedded in the multiple. The $265 billion US buildout thickens deterrence by making TSMC's survival an American balance-sheet interest, but Arizona at 5–8% of capacity through 2030 is resilience, not duplication. Part of the 'zero-growth multiple' is Taiwan rent. Owning TSMC is underwriting deterrence, and the position should be sized by that fact rather than pretending the discount is inefficiency.

## The cheapest monopoly in the AI stack

The market recognises TSMC's position and is unwilling to pay for its duration. Record margins are priced as a peak; single-digit price increases amid a shortage read as a ceiling where the mechanism says reserve; a demand curve pointing five-fold higher is offered the index multiple. The bullish reading requires no heroics: the yield gap keeps scrappage on competitors' books, pricing power stays banked rather than spent, and AI demand needs to arrive at only a fraction of forecast for zero-growth expectations to break. None of this requires TSMC to start charging monopoly prices; it needs only to remain the one factory that can make what everyone must buy, and the price it declines to charge stands as the measure of how much power is still in reserve.
