...
ticker: [KLAC, AMAT, LRCX, ASMI, TEL, BESI]
superseded_by: "[[Sectors/Semiconductor Capital Equipment]]"
source: Synthesis of Grok, Claude, Gemini, ChatGPT conversation exports + web research (SEMI April 2026 update, company filings, TrendForce, SemiEngineering, Reuters, Seeking Alpha)
---

> [!error] **ARCHIVED 2026-04-29 — content merged into sector hub**
> This multi-ticker thesis was merged into [[Sectors/Semiconductor Capital Equipment]], which now serves dual role as sector MoC AND basket-level investment hub. All Key Non-consensus Insights, Bull/Bear scenarios, Catalysts, Risks, Conviction Triggers, and Portfolio Allocation content was absorbed into the sector note's `## Investor heuristics` section. Inbound wikilinks across the vault have been redirected to the sector path. This file is preserved for historical traceability only — do not edit.
>
> Pre-merge snapshot: [[_Archive/Snapshots/SEMICAP - Semiconductor Capital Equipment (pre-merge 2026-04-29-120033)]]

# SEMICAP — Semiconductor Capital Equipment (ARCHIVED)

## Summary

WFE spending guided to **$135.2B in CY2026 (+9.0%, SEMI Apr 2026 update) and $156B in CY2027**, against a backdrop of four simultaneous technology inflections — GAA logic at 2nm volume, HBM4 ramp on microbump (HBM5 hybrid-bonding deferred to 2028-2029 per JEDEC's April 900µm relaxation), 400-layer 3D NAND requiring cryogenic etch in HVM 2026, and CoWoS scaling 75-80K → 120-130K wafers/month — for the first time in the industry's history. The correct framing is not *where in the cycle* but **the cycle itself has structurally changed**: WFE is transitioning from capacity-driven (more wafers) to **complexity-driven** (more equipment per wafer). Equipment revenue per wafer start rises even when wafer-start volume is flat — each GAA node adds ~$400M ALD SAM per 100K wafer starts; HBM4 16-Hi consumes 3x DRAM inspection intensity; cryogenic etch adds $2B (2027) of incremental NAND TAM; revenue per wafer start has roughly doubled from 45nm to 10nm and is up another 30-50% from 3nm FinFET to 2nm GAA for ALD and selective etch.

The non-consensus opportunity is not the obvious AI beneficiaries (ASML, LRCX) but **mispriced compounders with structural advantages obscured by stale narratives** — KLA's yield monopoly compounding through inspection-intensity inflation (~33-35x fwd despite best-in-sector 62% GM / 43% OM), AMAT's 15-turn discount to LRCX/ASMI on "conglomerate complexity" (~31x vs ~45-48x) despite every major inflection running through its integrated platforms, BESI's 3D-integration monopoly miscategorised as a binary HBM-timing bet (March 2026 SK Hynix mass-production Kinex order is logic/DRAM, not HBM; 150+ installed base predominantly at logic foundries), and TEL's 92% coater monopoly trading at a 10-15-turn Japan-discount despite essential EUV adjacency. High conviction across the basket; differential allocation by valuation gap to fundamentals.

---

## Key Non-consensus Insights

### 1. KLA is the most structurally underappreciated compounder in the entire equipment stack — the market prices it as a mature process-control business when it is actually the primary beneficiary of rising defect intolerance across every end market simultaneously.

HBM4 16-Hi requires **3x inspection intensity vs standard DRAM**; CoWoS doubles process-control spend per unit vs monolithic die. Process-control share rose from 50% (2010) to ~63% (CY2025), with Q2 FY26 (Jan 2026) at $3.30B revenue (+7.2% YoY), 62% gross margin, 43% operating margin — best-in-sector across both dimensions. Advanced-packaging revenue grew 70% in CY2025 to ~$950M; CY2026 guide is mid-high-teens growth on a $12B AP market. Service CAGR was raised to 13-15%, targeting ~$6B by 2030. A DCF anchored on inspection-intensity inflation (KLA content per wafer rising at 8-12%/yr vs WFE's 5-7%) produces ~30% upside from current. **The "process control matures with the node" narrative is exactly backwards — process control compounds *with* the node.**

### 2. Applied Materials is the most mispriced large-cap in semicap — every major inflection runs through its integrated platforms, but the market still discounts it 15 turns vs LRCX/ASMI on a "conglomerate complexity" narrative that has gone stale.

~31x forward P/E vs LRCX ~48x and ASMI ~45x is a 15-turn discount on stale framing. Every major inflection now flows through AMAT's integrated platforms: **GAA** (molybdenum interconnects on Endura PVD), **BSPDN** (CMP + bonding prep), **hybrid bonding** (9% BESI stake → Kinex integrated platform), **3D DRAM** (epi for vertical channel transistors), **advanced packaging** (CMP + selective etch + thermal). Q2 FY26 guide is $7.65B with management projecting **>20% equipment growth in CY2026** — a 15-percentage-point acceleration from FY2025's 4.4% revenue growth. The EPIC Center in Silicon Valley creates decade-long customer lock-in: TSMC developing 1.4nm inside EPIC Center means Copy Exact mandates AMAT tools in every high-volume fab, and SK Hynix's R&D partnership announced March 2026 deepens the moat. ICAPS guided flat-to-slightly-down for CY2026 represents already-derisked downside; reacceleration in H2 2026 is unpriced upside option. **Best risk/reward in the sector.**

### 3. Advanced packaging equipment grows 40%+ regardless of HBM hybrid-bonding timing — the "when does hybrid bonding inflect" debate is a distraction from a base-case demand curve that is already inflecting on microbump architectures.

CoWoS capacity expansion (75-80K → 120-130K wafers/month by late 2026, 3.7x since 2024), TSV etch intensity, and inspection requirements are all inflecting now on microbump-based HBM3E and HBM4. LRCX advanced packaging revenue is guided **+40% CY2026** (from ~$1.5B base); KLA inspection grew **+70% CY2025** entirely on microbump-based HBM3E and CoWoS — zero hybrid bonding contribution. JEDEC's April 2026 relaxation of HBM package height to ~900µm (vs original 775µm draft) confirms HBM4 16-Hi stays on microbump/MR-MUF; mandatory HBM hybrid-bonding moves to HBM5 (2028-2029). But **logic-side hybrid bonding has already started**: SK Hynix placed first mass-production Kinex order March 2026 (AMAT + BESI integrated D2W); TSMC SoIC scaling to 50K wafers/month by 2027; BESI has 30 bonders deployed across 6 integrated logic production lines at a leading customer. Hybrid-bonding inflection is *additive* upside to a 40%-growth base case, not the base case itself.

### 4. The cycle is complexity-driven, not capacity-driven — the durable variable is equipment revenue per wafer start, not wafer-start volume, and this re-orders who compounds through the cycle.

Historic WFE cycles scaled with wafer-start volume; this one scales with **process steps per wafer**. FinFET → GAA nanosheet adds 100-250 process steps. 2D NAND → 400+ layer 3D NAND raises etch aspect ratio from 60:1 to >100:1, opening a new cryogenic-etch market ($500M 2023 → $2B 2027). Monolithic die → CoWoS converts 1-die packages into 10+ die. Front-side only → BSPDN adds new wafer-bonding/thinning modules. Equipment revenue per wafer start has roughly doubled from 45nm to 10nm and is up another 30-50% from 3nm FinFET to 2nm GAA for ALD and selective etch. **Implication for stock selection**: re-rate candidates are not those with the most volume exposure but those with rising-intensity exposure — KLA (intensity per package), ASMI (ALD content per node), LRCX (selective etch tripling at GAA), BESI (hybrid-bond per die-stack). Even flat wafer-start volume produces rising WFE demand under this model, making the cycle **structurally less violent on the downside** than 2007-2009 or 2022-2023.

### 5. Tokyo Electron is a structural mispricing on Japan discount — a 92% coater/developer monopoly essential to every EUV-equipped fab on Earth, trading at lower multiples than Western peers despite comparable margins and equal exposure to the same GAA/HBM/3D NAND inflections.

92% coater/developer share — no EUV fab on Earth operates without TEL tools, and every High-NA EUV ASML ships requires a corresponding TEL track system. ~35x forward P/E vs ASMI 45x and LRCX 48x despite a monopoly position in a critical EUV adjacency, comparable margins (~43-45% GM, ~25% OM), and equal exposure to GAA/HBM/3D NAND. **Cryogenic etch is the bonus**: TEL's tool achieves 10µm-deep etch at -70°C with 2.5x etch rate and 84% GWP reduction, enters HVM 2026 for 400-layer NAND channel-hole etch (Samsung named first customer; SK Hynix in test). Share opportunity: 0% → material in a $2B (2027) TAM. Japan-listed discount and headline China revenue noise mask structural quality that should command parity with Western peers.

### 6. The optical equipment enabler chain — foundry (TSEM, GFS), test (FORM, AEHR), assembly (FN) — is the true picks-and-shovels of the photonics supercycle, dramatically cheaper than the laser/transceiver names the market has already bid up 300-900%.

LITE (+867%), COHR (+150%), AAOI (+300%), AXTI (+500%) over 24 months have priced in the laser/transceiver supercycle. Optical characterisation is dramatically slower than electrical testing and **cannot localise loss mechanisms** — the actual CPO mass-production bottleneck. Real chokepoints: **FormFactor (FORM)** optical metrology probes, Advantest partnership on wafer-level HBM; **Aehr Test (AEHR)** wafer-level SiPh burn-in (Q3 FY26 $37.2M bookings + $50.9M backlog + March 2026 hyperscale optical-interconnect win); **Tower Semiconductor (TSEM)** tripling SiPh foundry capacity by mid-2026; **GlobalFoundries (GFS)** world's largest pure-play SiPh foundry post-AMF Singapore acquisition (targeting $1B+ photonics revenue by 2030); **Fabrinet (FN)** NVIDIA's primary optical-assembly partner. All trade at fractions of laser/transceiver valuations and win regardless of CPO vs pluggable mix. **Highest asymmetric leverage in the sector.**

---

## Outstanding Questions

1. **Is CY2026 WFE actually $135B, $145B, or higher?** SEMI's April 2026 mid-year update guides $135.2B (+9.0%); broader semi equipment $145B; Bank of America projects $131-150B. Variance is almost entirely a China spending assumption. Every $10B of WFE maps to ~$3B of LRCX+AMAT+KLAC combined revenue.

2. **Advanced packaging as % of WFE by 2028?** Today ~10% (~$12B on KLAC's CY2026 guide). With CoWoS scaling 75-80K → 120-130K and logic hybrid bonding transitioning independent of HBM, packaging could reach 15-20% by 2028. Re-orders relative importance of LRCX (TSV etch, ECD), KLA (3x inspection intensity), BESI (hybrid bonding), AMAT (CMP, bond prep). Which beneficiary captures the most incremental share?

3. **Does the GAA transition actually triple ALD/selective-etch SAM as guided?** ASMI claims 12%+ CAGR through 2030 on GAA; LRCX guides GAA revenue "triples" CY2026; AMAT guides equipment growth >20% CY2026. TSMC N2 reached volume Q4 2025 with both Taiwan fabs sold out for 2026; Samsung SF2P hit 70% yield Jan 2026; Intel 18A entered HVM Jan 21, 2026 at 30K wafers/quarter. If claims are accurate, ASMI/LRCX deserve structural premium. **If overstated by 30%+, both are 25-35% overvalued at current ~40-48x forward.**

4. **Does Chinese domestic equipment share keep rising at +10pp/yr?** Domestic share hit 35% in 2025 (vs 30% target, up from 25% in 2024); etch and thin-film deposition already exceed 40%. NAURA FY2025 revenue CNY 39.35B (~$5.4B, +30.85% YoY); AMEC's 5nm etch validating at TSMC. Roadmap targets 50-60% by 2030. **Every 5pp of China share shift removes ~$4-5B from Western vendors' TAM.**

5. **AMAT CY2026 growth execution.** Management guided >20% equipment growth — a 15-percentage-point acceleration from FY2025's 4.4%. Both ICAPS recovery and GAA ramp must materialise. Q2 FY26 earnings (May 2026) will be the first read.

6. **LRCX foundry/logic mix durability.** LRCX achieved 59% Foundry/Logic revenue in Q2 FY26 (vs historically memory-heavy mix). Structural (permanent GAA etch share gains) or cyclical (temporary memory order weakness)? If structural, LRCX deserves a permanent re-rating toward logic multiples.

7. **High-NA EUV adoption — 2 customers or 6 by 2030?** Intel leads with world's first commercial High-NA line at 30K wafers/quarter for 18A (HVM Jan 2026); Samsung second unit H1 2026 at Taylor Texas; SK Hynix one unit; imec one unit (March 2026 delivery). TSMC deferred High-NA for 1.4nm. ASML guides 5-10 High-NA deliveries in 2026. At >€350M per tool, customer absorption capacity is the gating variable. Sub-6 customer adoption doesn't threaten ASML's EUV monopoly but caps revenue-per-tool dynamics.

8. **HBM5 hybrid-bonding inflection timing.** JEDEC 900µm relaxation moves mandatory HBM hybrid-bonding to HBM5 (2028-2029). SK Hynix and Samsung are extending MR-MUF for HBM4 / HBM4E. If HBM5 timing slips to 2030, BESI's HBM revenue inflects later than current 2026-2027 modelling. If it pulls forward to 2027 (Samsung yield breakthrough scenario), the sector reprices BESI overnight. Track HBM4E pad pitch (>10µm = continues microbump; <10µm = forces hybrid bonding earlier).

9. **BESI M&A resolution.** Reuters reported (March 2026) dual takeover interest from LRCX and AMAT. Dutch national-security review required (6-12 months). Outcome materially affects BESI's standalone valuation, the strategic positioning of whichever acquirer wins, and whether the BESI / ASMPT / Samsung Semes competitive dynamic resets. AMAT's existing 9% stake gives pre-emptive informational edge.

10. **CPO yield stabilisation at TSMC.** TSMC's COUPE platform is in risk production (NVIDIA GTC 2025; Broadcom) but yields are "below ideal." Volume CPO deployment at >10M ports by 2029 requires yield convergence with mature CMOS. Slow convergence pushes optical-test (FORM, AEHR) and SiPh foundry (TSEM, GFS) revenue inflection to 2028+; fast convergence pulls it to 2026-2027.

11. **MATCH Act / Section 232 escalation.** January 15, 2026 Proclamation imposed 25% tariff on narrow advanced-logic chip imports. April 2, 2026 MATCH Act introduced in House proposes extending controls to DUV immersion litho **and servicing of existing equipment in China**. ASML China exposure already guided to ~20% of 2026 sales (from 33% in 2025). **The servicing ban is the stealth risk vector** — recurring-revenue annuity on China-installed base is where AMAT and LRCX have highest exposure.

12. **Taiwan tail-risk sector pricing.** Per [[Research/2026-04-19 - TSM - Stress Test]], a -85-95% Taiwan permanent-impairment scenario consumes 100% of ASML global EUV output for 12-18 months on rebuild. Arizona buildout = only 5-8% of TSMC capacity through 2030. **Sector's customer-concentration tail is quantifiable but not discounted in sell-side multiples.** What multiple-haircut would a credible 10% probability-weighting imply across the basket?

---

## Business Model & Product Description

Semiconductor capital equipment companies sell the tools (typically **$1M–$400M per system**) that chip manufacturers use to fabricate integrated circuits. Four characteristics define the business model:

**1. High barriers to entry.** Developing a new advanced-node tool requires $500M-$5B in R&D over 5-10 years, with no guaranteed customer qualification. ASML's EUV took ~20 years and $10B+ of cumulative industry investment, funded in part by a 2012 customer co-investment program in which Intel, TSMC, and Samsung took combined ~€1.4B equity stakes. BESI's Kinex hybrid bonder consumed five years of joint development with Applied Materials. Atomic-scale precision (sub-nm defect tolerance at 2nm; sub-0.5nm copper roughness for hybrid bonding), cleanroom compatibility, and process-of-record qualification create 12-24 month switching barriers. Customers Copy Exact tools across fab fleets — once qualified, a tool gets reordered.

**2. Oligopoly structure with effective monopolies.** Top-5 WFE vendors (ASML, AMAT, LRCX, TEL, KLAC) capture ~75% of industry sales. Top-5 composition has been stable for 15+ years; share shifts at the margin (±2-3 points per technology transition). Effective monopolies in critical sub-categories: EUV lithography (ASML 100%), EUV mask inspection (Lasertec ~95%, ZEISS now competing on High-NA), coater/developer (TEL ~92%), batch ALD (Kokusai ~70%), D2W hybrid bonding (BESI ~67%), CMP (AMAT ~70%), single-wafer ALD (ASMI ~55%+). Co-development cycles of 5-10 years and exponentially rising precision requirements mean new entrants cannot close the gap as it widens.

**3. Razor-and-blade economics.** Initial system sales are followed by 15-20 years of high-margin spare parts, upgrades, and service contracts. Service/installed-base revenue is **typically 30-40% of total** and grows at stable double-digit rates regardless of capex cyclicality, reflecting annuities embedded in 45,000+ AMAT tools, 100,000+ LRCX chambers, and the global EUV/DUV installed base. AMAT's Applied Global Services (AGS) and LRCX's Customer Support Business Group (CSBG, **$7.2B CY2025**) are both $2B+ annuity streams. KLA raised its service CAGR guide to 13-15%, targeting **~$6B service revenue by 2030**. The service annuity is what makes a 2022-2023-style downturn ~25% peak-to-trough at revenue level rather than 50%+.

**4. Cyclicality with secular uptrend.** Revenue correlates with chipmaker capex cycles (typically 2-4 year duration), but the long-term trend is structurally upward as complexity per wafer increases. The current cycle is **more durable than historical patterns** because demand is driven by multiple simultaneous technology transitions (GAA, HBM, 3D NAND, CoWoS, BSPDN, CPO) rather than a single end market — a cyclical setback in any one transition is offset by the others.

### Revenue segmentation by end market (approximate CY2026)

| End Market | % of WFE | Growth Driver | Equipment Beneficiaries |
|:---|:---|:---|:---|
| Leading-edge Logic/Foundry (2nm GAA) | ~45% | TSMC N2 sold out; Intel 18A HVM Jan 2026; Samsung SF2P 70% yield | AMAT, LRCX, ASMI, KLAC, ASML |
| Memory (DRAM/HBM + NAND) | ~30% | HBM4 ramp (microbump); 400L NAND cryogenic etch; 1γ DRAM | LRCX, TEL, Kokusai, KLAC |
| Advanced Packaging | ~10% (fastest growth ~40%+ CY26) | CoWoS 75-80K → 120-130K w/m; logic hybrid bonding | BESI, AMAT, LRCX, KLAC, ASMPT, EVG |
| Mature/ICAPS (28nm+) | ~15% | Auto/industrial recovery; China indigenisation | AMAT, NAURA (China), AMEC (China) |

### Tool installed base, replacement, and cost structure

**Lifecycle.** Equipment runs 15-20 years before scrap, with major refurbishments at 7-10 years. Used-tool secondary market is actively operated by chipmakers and Chinese buyers (a meaningful workaround for export-controlled new tools). TSMC has historically operated 8-10 generations of tools in parallel as nodes coexist. **Replacement-driven revenue is roughly 20-25% of new tool revenue annually on a steady-state basis.**

**Cost structure.** Top-5 OEMs run 45-65% gross margins and 25-43% operating margins. Fixed cost is dominated by R&D (15-18% of revenue at AMAT/LRCX/ASML; 14% at KLAC) and customer-engineering field-service headcount. Variable cost is materials and components — Carl Zeiss optics for ASML, precision motion stages, vacuum chambers, photonics sources. **Carl Zeiss SMT capacity is currently the binding constraint on ASML EUV throughput** ([[Research/2026-04-24 - Dylan Patel on AI Token Supply and Demand - video-transcript]]) — not ASML's own assembly capacity, not customer demand. Tail-whip pre-payments along the supply chain (Dylan Patel, April 2026) signal demand far exceeds available output through 2027.

---

## Industry Context

### Industry history (1960s → present)
...
### Pricing power trajectory (historical → forward)
...
**Pricing-power summary.** EUV unit prices rose ~$120M (NXE:3400) → ~$200M (NXE:3800) → **>€400M (EXE:5200 High-NA)** — a ~3.3x ASP inflation across a single decade. BESI hybrid bonder ASPs rose ~20% Gen-1 → Gen-2 with Gen-3 development underway. AMAT Sym3 etch tool ASPs **roughly doubled** across the FinFET-to-GAA transition. Service/installed-base revenue grows at stable double digits regardless of capex cyclicality, reflecting annuity embedded in 45,000+ AMAT tools and 100,000+ LRCX chambers globally. KLAC raised service CAGR guide to 13-15%, targeting ~$6B service revenue by 2030. The pricing-power trajectory is **uniformly positive** at the leading edge, with the only erosion being mature-node tool ASPs facing Chinese vendor competition — a category outside the leading-edge thesis.

### Product-level vendor map
...
| Company | Ticker | Share | Key Products | Notes |
|:---|:---|:---|:---|:---|
| **BESI** | BESI.AS | ~67% D2W hybrid; 42% die attach | Kinex (inline with AMAT), Gen-2 50nm | Q4 2025: €166.4M rev (+25.4% QoQ, +8.5% YoY), €250.4M orders (+43.3% QoQ, +105.4% YoY), 63.9% GM, €42.8M net (+69% QoQ). 150+ installed hybrid bonders at 18 customers; 30 bonders deployed at 6 integrated logic production lines (with AMAT). Q1 2026 (April 23): guided +5-15% QoQ rev, 63-65% GM. **SK Hynix first mass-production Kinex order March 2026** (AMAT+BESI integrated D2W). Reuters March 2026: dual LRCX/AMAT takeover interest. ~€476M hybrid-bonding revenue estimate for 2026 (pre-JEDEC 900µm relaxation; monitor for HBM4 revenue timing slippage). Projected 1,400 systems by 2030 (~€2.8B equipment TAM). |
...
| **TOWA** | 6315.T | Niche (molding) | High-density molding | New tech for 16-Hi HBM stacking. |
...
### M&A history — the consolidation record
...
### Macro forces shaping the cycle

#### A. The complexity multiplier
...
| HBM3E (8-12 Hi) → HBM4 (16 Hi microbump/MR-MUF) → HBM5 (20+ Hi hybrid) | Stack height 825µm → ~900µm (JEDEC Apr 2026) | BESI delayed to HBM5 (2028-2029); HBM4 revenue stays on TC bonders (ASMPT, Hanmi) |
...
| Copper I/O → Silicon photonics | New photonic modules | FORM, AEHR, TSEM, GFS, FN |

**Implication.** Equipment revenue per wafer start is structurally increasing at every node transition. Historic revenue-per-wafer-start doubled from 45nm to 10nm; at 2nm GAA it is 30-50% higher than 3nm FinFET for ALD and selective etch. Even flat wafer starts produce rising WFE demand.
...
- **Near-term:** BESI's HBM-derived hybrid-bonding revenue deferred. SK Hynix publicly committed to MR-MUF for HBM4 16-Hi (CES 2026), using 30µm-thinned wafers to stay within 775µm under prior specification; 900µm relaxation cements microbump continuation. Samsung plans partial HBM4E deployment at earliest.
- **Medium-term:** **HBM5 (2028-2029) becomes the mandatory hybrid-bonding transition point.** Pad pitch tightening below 10µm at HBM5 makes microbumps thermally infeasible.
...
- **Implication for SEMICAP/BESI thesis:** monitor revenue timing vs €476M 2026 hybrid-bonding estimate; monitor AMAT takeover interest (undiminished by HBM timing since logic integration is AMAT's primary interest). See [[Theses/BESI - BE Semiconductor Industries]].
...
Equipment makers sit between material suppliers (wafer substrates, gases, chemicals) and device manufacturers (TSMC, Samsung, Intel, SK Hynix, Micron). They have pricing power because **equipment is <10% of a fab's lifetime cost but determines 100% of its yield and output capability**. Customer pricing power is partially offset by Copy Exact dependency: once a tool is qualified into a node, switching costs are weeks of yield risk per tool — and yield risk at 2nm GAA can mean millions in lost wafer output per day.
...
## Portfolio Allocation — What to Own

The recommended allocation prioritises structural compounders trading below peers on stale narratives, with satellite positions in higher-beta names for specific technology exposure.
...
- **Advantest/Teradyne:** Test equipment is more exposed to smartphone/mobile cyclicality than AI. AI chip test complexity is growing but the companies trade at premiums that reflect this. Less compelling than the core semicap names.
...
## Adjacent Active Theses

The SEMICAP basket is supported by upstream/downstream demand flows in these vault theses:

- [[Theses/BESI - BE Semiconductor Industries]] — 3D-integration monopoly miscategorised as HBM-timing play; LRCX/AMAT dual takeover interest
...
- [[Theses/SNDK - SanDisk]] — HBF (hybrid-bonded flash) is a second hybrid-bonding TAM vector beyond HBM
- [[Theses/IQE - IQE]] — III-V substrates enabling photonics equipment supply chain
- [[Theses/TSM - Taiwan Semiconductor]] — Leading-edge foundry concentration; primary WFE customer; Taiwan tail-risk anchor
...
- **2026-04-15:** [Thesis created]. Synthesised Grok/Claude/Gemini/ChatGPT exports + web research. WFE $135B CY2026, TSMC CoWoS 35K→130K wafers/month, KLA adv. packaging $950M CY25. Core conviction: KLA and AMAT highest risk-adjusted; LRCX correctly priced; TEL and photonics test names are overlooked asymmetric plays.
...
- **2026-04-22:** Sector re-scoped: Semiconductors & Photonics → Semiconductor Capital Equipment (vault-wide subsector taxonomy reorganisation).
- **2026-04-22 (Wikilink cleanup):** Replaced stale `[[Sectors/Semiconductors]]` parent reference with `[[Sectors/Semiconductor Capital Equipment]]` in Related Research; parent sector note retired during vault reorganisation. Thesis body unchanged; conviction unchanged.
- **2026-04-23:** Wikilink cleanup: `[[Sectors/NAND Flash & Storage]]` → `[[Sectors/NAND Memory & Storage]]` (both Related Research and 2026-04-16 log entry; sector file renamed). Conviction unchanged.
- **2026-04-24 (/sync):** [[Research/2026-04-24 - Dylan Patel on AI Token Supply and Demand - video-transcript]]: "ASML completely sold out, needs Carl Zeiss to expand faster" + TSMC 2028 capex ~$100B implied + tail-whip prepayments across upstream supply chain — directly validates complexity-driven supercycle Bull Case. Conviction strengthened at high-end of existing high.
- **2026-04-24 (/sync):** [[Research/2026-04-24 - Iran War Japan Semiconductor Photo Materials Shortage - news]]: PCN requalification cycle (~1 year) for alternate PR/BARC solvents creates near-term fab procurement uncertainty that flows to SEMICAP via customer capex-timing friction. Impact magnitude depends on disruption duration; monitor Samsung/Hynix Q2 2026 earnings for HBM-tool order slippage signal. Conviction unchanged.
- **2026-04-29 (Sector merge):** Manual edit: Subsumed `[[Sectors/Semiconductor Capital Equipment]]` MoC content into this thesis. Sector note moved to `_Archive/Sectors/Semiconductor Capital Equipment.md`. Thesis now serves dual role: (i) multi-ticker SEMICAP investment thesis; (ii) sector hub absorbing prior MoC's Industry History, Competitive Dynamics, Product-level vendor map, M&A history, Macro forces (complexity multiplier, JEDEC HBM4 reset, geopolitical bifurcation, AI capex floor, customer concentration / Taiwan tail). Materially deeper Industry Context section; new Conviction Triggers section per template; Risks expanded with Carl Zeiss bottleneck, JEDEC slippage, MATCH Act servicing-ban, PCN requalification. Inbound wikilinks across vault redirected from sector path to this thesis. Frontmatter `tags` adds `sector-hub`; `last_updated: 2026-04-29` added. Pre-merge snapshots: `_Archive/Snapshots/Semiconductor Capital Equipment (pre-merge 2026-04-29-120033).md` + `_Archive/Snapshots/SEMICAP - Semiconductor Capital Equipment (pre-merge 2026-04-29-120033).md`. Conviction unchanged (high). User should run `/graph last` to reconcile `_graph.md` adjacencies post-merge.
