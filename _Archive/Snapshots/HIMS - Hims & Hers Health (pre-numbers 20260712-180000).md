---
snapshot_of: "[[Theses/HIMS - Hims & Hers Health]]"
...
~$19 (~1.5x P/S), down from $70+ after FDA enforcement, DOJ referral, and the Jun 23, 2025 Novo Nordisk partnership termination (citing "deceptive marketing" and "illegal mass compounding"; stock -34.6%). [Corrected 2026-07-10: the thesis originally had the Novo chronology inverted — the termination was Jun 23, 2025, and Mar 9, 2026 was the REINSTATEMENT (new collaboration, patent suit dropped, +40.8% day), active through July 2026.] $2.35B FY2025 revenue (+59% YoY), 2.5M subscribers, $128M GAAP net income, $318M adj. EBITDA. HIMS is building vertically integrated consumer health infrastructure — 503B manufacturing, MedMatch AI personalization (58% on personalized plans), multi-condition subscription distribution. Concurrent DOJ, SEC, and FTC investigations plus securities class action. With peptide reclassification confirmed (RFK Jr., Feb 27, 2026), Eucalyptus closing mid-2026 ($1.15B), and Q1 earnings May 11, risk/reward is asymmetric if the platform thesis survives. 46% short interest amplifies both directions.
...
- Oral GLP-1 alternatives (bupropion/metformin/naltrexone/topiramate kits at $69-100/month) offer 5-8% weight loss vs. 15-20% for injectable GLP-1s — efficacy gap creates retention risk
