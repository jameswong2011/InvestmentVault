...
snapshot_batch: sync-2026-06-27-175739
date: 2026-06-10
...
**The upstream pinch point.** Nittobo holds ~90% of T-glass and ~60–70% of NER-glass, with order books full through end-2026 and triple-capacity (¥150B investment) not arriving until mid-2027. This glass-cloth scarcity is simultaneously (a) the industry's binding constraint, (b) EMC's allocation moat, and (c) an input-cost risk if pass-through stalls.
