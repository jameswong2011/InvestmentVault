...
status: draft
sector: OSAT
snapshot_of: "[[Sectors/OSAT - Outsourced Semiconductor Assembly & Test]]"
snapshot_date: 2026-06-18
snapshot_trigger: sync
snapshot_batch: sync-2026-06-18-094952
---
...
3. **Does FOPLP (Fan-Out Panel-Level Packaging) move OSAT value-add back to foundries or stay with pure-plays?** TSMC CoPoS (panel-on-substrate) target pushed from 2028 to "Q4 2030 minimum" per March 2026 roadmap revision (cited in [[Macro & Technology/Organic ABF to Glass-Core Substrate Transition]]). Samsung, Powertech, and ASE FOEB are evaluating panel-level pilot lines on 600×600mm panel format. **If panel-level packaging matures at OSATs first (because TSMC delays), pure-play OSAT advanced-packaging revenue extends by 18-24 months and possibly captures the next-generation interposer franchise.** If TSMC hits CoPoS on schedule, OSAT is the loser.
...
4. **TSMC CoPoS delay extends OSAT advanced-packaging runway 18-24 months.** TSMC CoPoS (panel-on-substrate) target slipped from 2028 to Q4 2030 minimum per March 2026 roadmap revision (cited in [[Macro & Technology/Organic ABF to Glass-Core Substrate Transition]]). For pure-play OSATs, the delay means CoWoS overflow continues at higher volume into 2028-2029 than previously modelled. **Net positive ~$2-3B aggregate OSAT advanced-packaging revenue extension** vs the prior-roadmap baseline. Powertech and ASE FOPLP investments may capture next-gen interposer franchise if their panel-level pilots reach HVM ahead of TSMC.
...
**Insight #2 — TSMC CoPoS delay extends pure-play OSAT advanced-packaging franchise 18-24 months past consensus.** March 2026 TSMC roadmap revision pushed CoPoS HVM from 2028 to Q4 2030 minimum. Pure-play OSAT sell-side models still extrapolated 2028 CoWoS verticalisation pace; the actual runway is 24-30 months longer. **Net positive ~$2-3B aggregate ASE + Amkor advanced-packaging revenue 2027-2029 vs prior consensus**, modelled at 25-30% GM — material to 2028 EPS for both names.
