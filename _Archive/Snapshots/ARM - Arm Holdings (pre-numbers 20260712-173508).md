---
snapshot_of: "[[Theses/ARM - Arm Holdings]]"
...
1. **Agentic AI makes the CPU a co-equal compute layer.** The vault's [[Research/2026-04-24 - Agentic AI CPU Bottleneck and Server CPU Framework - deep-dive]] (Sekar framework) shows tool processing is 50–90% of agentic latency on the CPU, pushing CPU:GPU rack ratios above 1:1 — expanding ARM's datacenter TAM.
