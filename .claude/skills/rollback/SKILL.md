...
**Word cap**: after all edits, if over 8,000 words (soft cap per `_shared/hot-md-contract.md`), prune `## Sync Archive` (oldest first) then `*Previous:*` lines. Abort if over 10,000 hard cap.
