...
- [[Sectors/Semiconductor Capital Equipment]] — Back-reference: cited in sector hub under Product-level vendor map (Photonics & Optical Equipment Enablers — CPO vendor analysis feeds foundry/assembly/test capacity build for TSMC COUPE ramp).
