...
- [[Sectors/Semiconductor Capital Equipment]] — Back-reference: cited in sector hub under Industry Context > New entrants (Chinese photonics equipment entrant landscape) and Macro forces (geopolitical bifurcation — trailing-node domestic substitution vs leading-edge Western chokepoint).
