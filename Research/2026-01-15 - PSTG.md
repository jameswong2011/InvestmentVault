...
## Related Sectors
- [[Sectors/Enterprise Storage Infrastructure]] — cited in §Industry history (AFA transition 2008–2016), §Competitive dynamics (Dell/NetApp/HPE/Huawei positioning), §Product level analysis (DirectFlash architecture context), §Macro shifts (flash-HDD TCO crossover, AI I/O blender, hyperscaler design win), §Investor heuristics (Pure valuation premium vs peers); DirectFlash economics + hyperscaler penetration + VAST competitive frame are core inputs to the sector analysis.
