...
**1. "Second-source" is the business model, not a weakness — MediaTek is Google's pricing-power lever against Broadcom.**
...
- **Falsifier:** Google re-consolidates TPU design toward Broadcom or in-sources, or MediaTek's share of 2027 TPU units lands below ~15% (→ LOW trigger).
...
- **Falsifier:** data-center GM disclosed/inferable at ≥45% with group GM stable as ASIC scales → ASIC is margin-neutral-to-accretive and the variant is wrong.
...
- **Falsifier:** MediaTek demonstrates a defensible IP layer (competitive 224G+ SerDes or proprietary packaging edge) that sustains ≥60% ASIC gross margin → it is becoming a layer-owner; upgrade.
...
- **Falsifier:** mobile revenue restabilizes (flat-to-up YoY) through 2026-H2 with flagship share gains at a major Chinese OEM → funding base intact.
...
- **Falsifier:** Google cuts TPU volume or defers v8i/v9 in a capex pullback → cost-leadership does not insulate MediaTek; its ASIC backlog reprices like any other second-source.
