...
- **At what point does algorithmic efficiency overwhelm Jevons Paradox and reduce aggregate GPU demand?** Muon halves GPU cost per model; TurboQuant compresses KV cache 6x; trillion-parameter models now run on Apple Silicon. DeepSeek trained at 1/20th Western cost, suggesting efficiency gains create new adoption layers, but what if marginal adopters generate less compute demand than efficiency gains subtract? SemiAnalysis (Aug 2026) does not close this: open catch-up half-life is itself an efficiency channel (distillation on a shrinking clock), offset by (a) each new era re-opening a closed-lab compute binge and (b) the $100M/MW vs sub-$30M/MW auction reallocating MW toward frontier-token sellers rather than shrinking the pool [1×: SemiAnalysis]. Fireworks >40T tokens/day (2× OpenAI API at end-March) is the current Jevons-sign volume print. The assumption still needs continuous empirical validation; next-era initial gap failing to re-widen, or open TaaS ROI converging on $100M/MW, is the falsifier.
...
Nvidia occupies the most strategically advantaged position in the AI value chain: the "picks and shovels" provider that benefits regardless of which downstream AI company captures end-user revenue. The more model providers that compete (OpenAI, Anthropic, Google, Meta, Mistral, open-source), the more aggregate compute they consume. Open-source model proliferation (Kimi K2.5 achieving 50.2% on HLE-Full vs GPT-5.2 at 45.5%, at 1/9th cost; GLM 5.3 / Kimi K3 now doing economically useful coding/agentic work [1×: SemiAnalysis]) accelerates enterprise AI deployment volume, a net positive for infrastructure demand. That does **not** mean the intelligence premium is already competed away: SemiAnalysis dates the open-vs-closed gap as cyclic (catch-up half-life ~8.5 mo → 4.8–6 mo → default <3 mo next era) and puts ARR in the model+harness product (Claude Code, $65B+ since May 2025), not the public-bench composite [1×: SemiAnalysis]. The $100M/MW frontier-token auction vs sub-$30M/MW open TaaS reallocates incremental megawatts toward the highest-ROI token seller rather than shrinking the MW pool. The "AI bubble" framing actually strengthens the infrastructure provider thesis: even bubble skeptics concede infrastructure providers are the "picks and shovels" winners, and data centers report demand exceeding capacity with vacancy rates at record lows (2.8% per CBRE).
...
| EV/EBITDA | ~28.3x | |
| FY2026 Revenue | $215.9B | +65% YoY |
| Q1 FY2027 actual | $81.6B | +85% YoY; GAAP GM 74.9% |
| Q2 FY2027 actual | $96.2B | +106% YoY; DC $89.0B; GM 75.0% GAAP/non-GAAP [IR] |
| Q3 FY2027 Guidance | $108.0B ± 2% | No China DC compute in outlook [IR] |
...
- **Open-source model proliferation increases infrastructure demand via Jevons Paradox.** The more AI becomes commoditized at the model layer, the more compute the ecosystem consumes in aggregate. Nvidia wins on volume regardless of which model company captures end-user revenue. SemiAnalysis (Aug 2026) confirms the sign: Fireworks >40T tokens/day and "good models being open source is good for AI infrastructure," with a new concentration mechanism — Anthropic+OpenAI are only 27% of 2026 net new GW today but should outbid open TaaS / colo / RecSys at $100M vs sub-$30M per MW [1×: SemiAnalysis]. That is *less* bearish frontier labs than the FUD tape and *more* two-sided for neocloud overflow; it does not reduce GPU demand.
...
- **Triggers + evidence status**: hypotheses tested, not verdicts:
	...
	- *Generalist [G-14] · Jevons / cheap compute unlocks workload Y [added 2026-08-22]*: Fireworks >40T tokens/day plus economically-used open models (GLM 5.3 / Kimi K3) is the volume channel; hypothesis still consistent with infrastructure demand, not a conviction move (per [[Research/2026-08-21 - NVDA - SemiAnalysis Open Models Catching Up - deep-dive]]).
	- Generalist [G-6]/[G-13]/[G-11] + Industry #8 [added 2026-08-27]: AgentX stresses software-like monopoly characteristics and the mispriced variable as agentic systems-software velocity / TTFI, not FLOPs; KV/routing/offload remaps the bottleneck vs raw GEMM. Hypothesis: the toll holds inside CUDA-upstream agentic serving and is contested on ATOM-only peaks and still-unbenchmarked TPUs. Per [[Research/2026-08-24 - NVDA AMD - SemiAnalysis AgentX InferenceXv3 CUDA Moat - deep-dive]].
- *Generalist [G-3] · cyclic gap vs secular commoditization [added 2026-08-22]*: do not apply mean-reversion to a step-function era clock. Next era (multi-day / multi-copy autonomy) should re-widen the closed-lab gap; falsify if that initial gap does not re-widen or open TaaS ROI converges on $100M/MW.
...
- [[Research/2026-08-21 - NVDA - SemiAnalysis Open Models Catching Up - deep-dive]]: cyclic open-vs-closed gap + $100M/MW frontier-token auction confirms Jevons / picks-and-shovels; does not fire a trigger (no `## Conviction Triggers`)
- [[Research/2026-08-21 - MRVL NVDA 000660 - Damnang Marvell Part 3 - deep-dive]]: NVLink Fusion + $2B as system-content (custom XPU + scale-up + SiPh); no three-party NVIDIA–SK hynix–Marvell program; no NVDA triggers to test

- [[Research/2026-08-24 - NVDA AMD - SemiAnalysis AgentX InferenceXv3 CUDA Moat - deep-dive]]: AgentX 1.0 / InferenceXv3 — CUDA moat as DCP/PCP + upstream recipe velocity + lifecycle integral, not rewrite cost; no NVDA triggers to test
- [[Research/2026-08-24 - 000660 MU SNDK - Hot Chips Day 1 Precious Memories - deep-dive]]: Vera Rubin ~20 TB/s HBM4 beachfront ceiling; customer of the memory talks, not a trigger
- [[Research/2026-08-27 - NVDA - Q2 FY27 Earnings Vera Rubin Production - earnings]]: Q2 FY27 $96.2B / DC $89.0B / GM 75% / Q3 $108B ±2% no China DC; Rubin full production, NBIS named
- [[Research/2026-08-27 - NVDA 000660 AVGO MRVL - NVLink Fusion NVHBM Custom HBM - news]]: NVHBM controller-in-base-die vs HBM4E; Trainium4 Fusion
- [[Research/2026-08-27 - AVGO NVDA 000660 - OpenAI Jalapeno ASIC Hot Chips - news]]: OpenAI Jalapeño Broadcom inference ASIC; InferenceX vs GB200/300 with STP/MTP qualifier
- [[Research/2026-08-27 - NVDA NBIS - Nscale 45B Vera Rubin Anthropic - news]]: Nscale $45B / 6-yr Anthropic Vera Rubin offtake, late 2027
- [[Research/2026-08-27 - 000660 - SK hynix HBM4 12-Hi MP 16-Hi Qual - news]]: SK hynix HBM4 12-Hi MP / 16-Hi qual (memory supply for Rubin)
- [[Research/2026-08-27 - 000660 SNDK 285A - Memory 68pct Cloud Capex 2027 - news]]: TrendForce memory 47%→68% of CSP capex 2026–27
- [[Research/2026-08-27 - NVDA AVGO MRVL 000660 - PhotonCap AI Infrastructure Value Chain Reading List - deep-dive]]: 19-layer AI-infra map: NVIDIA guidance as spreading bottlenecks, not GPU units
- [[Research/2026-08-26 - NVDA AVGO 000660 SNDK - Jasons Chips Hot Chips Day 3 Jalapeno - deep-dive]]: Hot Chips Day 3: Spectrum-X multiplane 1.7× fewer switches; BlueField-4 7.2 Tbps; Jalapeño process/moat
- [[Research/2026-08-29 - NVDA NBIS - Denies Pausing AI Compute Partnership - news]]: Denies ACP pause; July model still in place; $36B commitments as of 26 Jul
- [[Research/2026-08-29 - NVDA 000660 - Samsung 8-Layer HBM4E for NVHBM - news]]: SEDaily via SammyFans: 8-Hi HBM4E ask at 17–18 Gbps for NVHBM (unverified)
- [[Research/2026-08-29 - NVDA NBIS - AI Rack Density Power Cooling Limits - news]]: Rack-density ceiling is power/failure planning (GB300 142 kW; Rubin 190–230 kW; Kyber ~600 kW)
...
### 2026-08-27
- [[Research/2026-08-24 - NVDA AMD - SemiAnalysis AgentX InferenceXv3 CUDA Moat - deep-dive]]: agentic production traffic expands the systems surface (KV lifecycle, routing, DCP/PCP) where CUDA-adjacent upstream stacks iterate weekly; GB300 lifecycle revenue/MW leadership when wide-EP/disagg is live — supports Insight #1, does not prove permanent tok/s monopoly — no triggers registered — conviction unchanged (high).
- [[Research/2026-08-24 - 000660 MU SNDK - Hot Chips Day 1 Precious Memories - deep-dive]]: beachfront-limited HBM + decode-bound inference support the system-budget shift already in the 8-Hi / NVL576 research — conviction unchanged (high).
- [[Research/2026-08-27 - NVDA - Q2 FY27 Earnings Vera Rubin Production - earnings]]: Q2 $96.2B beats $91B guide; Rubin full production with NBIS named; Q3 $108B ±2% ex-China DC — conviction unchanged (high).
- [[Research/2026-08-27 - NVDA 000660 AVGO MRVL - NVLink Fusion NVHBM Custom HBM - news]]: Fusion NVHBM moves controller into HBM base die — containment of custom XPUs, not a CUDA trigger — conviction unchanged (high).
- [[Research/2026-08-27 - AVGO NVDA 000660 - OpenAI Jalapeno ASIC Hot Chips - news]]: OpenAI inference ASIC is Broadcom-built 700W HBM4; Pareto not an apples-to-apples CUDA-kill (STP vs MTP) — conviction unchanged (high).
- [[Research/2026-08-27 - NVDA NBIS - Nscale 45B Vera Rubin Anthropic - news]]: $45B Anthropic/Nscale Rubin offtake from late 2027 — demand print, not Q2 revenue — conviction unchanged (high).
...
### 2026-08-29
- [[Research/2026-08-27 - NVDA AVGO MRVL 000660 - PhotonCap AI Infrastructure Value Chain Reading List - deep-dive]]: PhotonCap 19-layer map inverts NVIDIA guidance as a system-level tell (memory/packaging/optics/power/grid/construction), not a GPU-unit or SiPh-adoption print; dedicated gaps at layers 13–15 and 17 — no registered triggers — conviction unchanged (high).
- [[Research/2026-08-26 - NVDA AVGO 000660 SNDK - Jasons Chips Hot Chips Day 3 Jalapeno - deep-dive]]: Spectrum-X multiplane (512×200G / 8 planes vs 64×1.6T = 102.4 Tbps) trades reliability + 1.7× fewer switches (optics TAM headwind) and 1.9× multi-tenancy; BlueField-4 7.2 Tbps is scale-in; Jalapeño is process/moat (9-month tapeout, Rust-like HDL, 128/rack >1 PB ≈ VR200 NVL72), not a CUDA-kill — no triggers registered — conviction unchanged (high).
- [[Research/2026-08-29 - NVDA NBIS - Denies Pausing AI Compute Partnership - news]]: Spokesperson: July ACP model 'still in place and continues to evolve due to high demand'; $36B typically 6-yr take-or-pay / revenue-share as of 26 Jul; Kress 'paid twice' (hardware + rental share) intact; WSJ tenant-approval / antitrust-worry claims remain unverified — no registered triggers — conviction unchanged (high).
- [[Research/2026-08-29 - NVDA 000660 - Samsung 8-Layer HBM4E for NVHBM - news]]: Unverified SEDaily: Nvidia asked Samsung for 8-Hi HBM4E at 17–18 Gbps for NVHBM instead of 12-/16-Hi; controller-in-base-die claims ~+30% BW / ~−15% power; NVL72→NVL576 cluster-scale rationale — supports Fusion custom-memory control, not a trigger — conviction unchanged (high).
- [[Research/2026-08-29 - NVDA NBIS - AI Rack Density Power Cooling Limits - news]]: DCK: ceiling is electrical engineering + failure planning, not chip count; modal enterprise 11 kW vs GB300 NVL72 142 kW, Rubin NVL72 unofficial 190–230 kW, Kyber ~600 kW 2H27; air impractical >~50 kW; 54 VDC copper wall ~200 kW; Rubin already ships 800 VDC, Vertiv/Schneider/Eaton/Delta commercial 2H26 — no triggers — conviction unchanged (high).
