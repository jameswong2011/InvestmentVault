...
- **HBF fills Jensen Huang's "completely unserved market": this is a TAM creation event rather than a TAM capture event, and the market is pricing it as an option rather than a probability.** HBF bridges HBM ($8-10/GB, 24-144GB) and enterprise SSDs ($0.10-0.20/GB) with ~$1/GB, 1.6 TB/s bandwidth (within 2.2% of HBM on Llama 3.1 405B inference), and 512GB-1TB per stack. SK Hynix OCP standardization partnership (February 2026) eliminates "Betamax risk": the two largest NAND and HBM suppliers jointly defining the standard. First HBF die taped out August 2026; samples 2027 (slipped from H2 2026), commercial products to follow. The commercially realistic early form is mixed HBF (+HBM) — read-dominant weights in HBF, write-heavy KV remaining in HBM — not the Investor Day HBF-only demo. Damnang’s 18 August bottom-up puts Google, not NVIDIA, at ~89% of a $0.95B base-case HBF revenue line ($0.84B of $0.95B); NVIDIA’s disclosed Rubin stack (288GB HBM4, 22TB/s, Dynamo, Groq LPX SRAM, NVLink Fusion) gives it little incentive to put HBF in a general-purpose GPU baseline. Direct revenue even at a $4.22B scale case is not the re-rate; second-order mix, 3–4× wafer absorption, and NBM-style cyclicality are. The Low-sleeve option’s strike is Google/Meta attach plus 512GB-class packaging yield, not Rubin HBF confirmation. Per [[Research/2026-08-18 - SNDK 000660 NVDA - Damnang HBF Sandisk Upside - deep-dive]]. **Hot Chips Day 1 (Jason's Chips, 24 Aug) is the HBF-realism pass, not a kill.** OXMIQ/PRAXMATI: HBF is **8–16× HBM capacity** and **25× worse** on bandwidth/latency vs HBM-G2 (~13× vs G3 on α); the metric that matters is $/token, not $/GB; useful attach is low-batch, personal/private boxes, and expert-parallelism (8 GPUs sharded → 2 HBF-capacity nodes), **off** the high-batch / high-interactivity Pareto where you are memory-bandwidth constrained [web: jasonschips.ai]. Author entered bullish after SanDisk Investor Day, left "slightly less bullish." That is closer to this file's own 18 August mix-HBF sleeve and "Google not NVIDIA" attach than to Investor Day "within 2.2% of HBM." Challenges the HBM-equivalent wording of this insight and Q1; does **not** answer Q4 (2027 samples vs 2028+ slip) and is not a 2027 sample-yield print. If the category works, NAND bit-to-HBM-like-cube conversion is a ~9× trade (SLC not TLC, then HBM-style stack) — shared with [[Theses/285A - Kioxia]] via Flash Ventures, not a 2026 earnings line. Per [[Research/2026-08-24 - 000660 MU SNDK - Hot Chips Day 1 Precious Memories - deep-dive]]. SNDK has no `## Conviction Triggers` to test.
...
- **Can HBF achieve commercial viability, or will it follow Intel Optane into technology graveyard?** HBF's 2.2%-of-HBM performance on Llama 3.1 405B is compelling in simulation, but Optane also showed promising lab results before failing commercially due to niche TAM, high manufacturing costs, and ecosystem resistance. The critical differences (SK Hynix partnership for standardization, OCP workstream, alignment with NVIDIA Rubin) reduce but don't eliminate this risk. The IC should assess: (1) whether NVIDIA commits to HBF integration on Rubin PCBs, (2) CBA-based manufacturing yields at scale, (3) whether hyperscalers are willing to re-architect their memory hierarchy for a new tier. The H2 2026 sampling window has been missed (first samples now 2027); if yields disappoint or NVIDIA stays uncommitted, the "AI premium" embedded in SanDisk's valuation could evaporate rapidly. *(Sources: [[Research/2026-01-18 - SNDK - Gemini AI Investment Canvas]], [[Research/2026-01-17 - SanDisk HBM and NAND in AI]])*
  ...
  - *2026-08-27 /sync:* Jason's Chips Hot Chips Day 1 — HBF 25× α gap vs HBM-G2; attach is low-batch / EP capacity, not HBM-substitute in a dense rack. Sentiment mark ("slightly less bullish"), not a sample-yield print. Q4 (2027 vs 2028+) untouched.
...
- [[Research/2026-08-24 - 000660 MU SNDK - Hot Chips Day 1 Precious Memories - deep-dive]]: HBF 8–16× capacity / 25× worse BW-latency vs HBM-G2; useful off the high-batch Pareto — challenges Investor Day HBM-equivalent wording, not Q4 sample window
- [[Research/2026-08-27 - 285A SNDK - Kioxia Kitakami 1T Yen Fab - news]]: Kitakami third building >¥1T inside already-modelled ¥470B/yr capex (Flash Ventures bit-add)
- [[Research/2026-08-27 - 000660 SNDK 285A - Micron 22B Prepay Memory Crunch 2028 - news]]: MU $22B SCA deposits / NAND ~1/3 of volumes under take-or-pay
- [[Research/2026-08-27 - 000660 SNDK 285A - Memory 68pct Cloud Capex 2027 - news]]: eSSD +~235% in 2026; memory 68% of CSP capex 2027
- [[Research/2026-08-27 - NVDA AVGO MRVL 000660 - PhotonCap AI Infrastructure Value Chain Reading List - deep-dive]]: HBF / optical memory pooling live on layer 19, not inside the HBM line
- [[Research/2026-08-26 - NVDA AVGO 000660 SNDK - Jasons Chips Hot Chips Day 3 Jalapeno - deep-dive]]: XCENA MX1 CXL 'infinite memory' is NAND-bullish; not an HBF bandwidth print
...
### 2026-08-27
- [[Research/2026-08-24 - 000660 MU SNDK - Hot Chips Day 1 Precious Memories - deep-dive]]: HBF is capacity at a 25× α haircut, not HBM bandwidth; mix-HBF / Google-not-NVIDIA sleeve already in the file — no triggers registered — conviction unchanged (medium).
- [[Research/2026-08-27 - 285A SNDK - Kioxia Kitakami 1T Yen Fab - news]]: Kitakami third building is a use of the ¥470B/yr envelope, not extra — JV bit-add, not a controller print — no SNDK triggers — conviction unchanged (medium).
- [[Research/2026-08-27 - 000660 SNDK 285A - Micron 22B Prepay Memory Crunch 2028 - news]] / [[Research/2026-08-27 - 000660 SNDK 285A - Memory 68pct Cloud Capex 2027 - news]]: industry take-or-pay + eSSD +235% supports the structural-GM debate as industry-wide — conviction unchanged (medium).
...
### 2026-08-29
- [[Research/2026-08-27 - NVDA AVGO MRVL 000660 - PhotonCap AI Infrastructure Value Chain Reading List - deep-dive]]: HBF stays on layer 19 (storage / memory disaggregation), not the HBM line; no SNDK triggers to test — conviction unchanged (medium).
- [[Research/2026-08-26 - NVDA AVGO 000660 SNDK - Jasons Chips Hot Chips Day 3 Jalapeno - deep-dive]]: MX1 (SSD-as-memory / DRAM-as-cache; 'infinite memory') is generally NAND-bullish; not an HBF bandwidth print — conviction unchanged (medium).
