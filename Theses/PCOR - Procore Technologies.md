...
**4. Can Davis execute the GTM rigor playbook without alienating Courtemanche-era culture?** Vertical-SaaS founder-to-operator transitions succeed when the new CEO formalizes pricing, channel, and segment GTM while preserving product-velocity culture. Tyler's Lynn Moore transition is the gold standard; Salesforce's Bret Taylor co-CEO experiment is the failure mode. Davis's first material data point — Q4 2026 sales-force reorg or pricing-segmentation announcement — will reveal trajectory. Below-the-fold risk: Courtemanche as Executive Chairman could veto operator-CEO reforms, mirroring Schultz-Niccol dynamic at Starbucks. Answered by analyst-day commentary (Q1 2027) on sales-force restructuring.
...
| Revenue Growth | 19% FY24 / guided 14-15% FY26 | Deceleration reflects ABI trough + tougher comps; mega-project mix improving ARPU |
| Gross Margin | ~83% non-GAAP | Industry-leading; reflects pure-SaaS model with no services drag |
| FCF Yield | ~3% | FCF margin 17-20% on $1.15B revenue; ~$200M annualized FCF |
...
Davis CEO transition stumbles: sales-force restructuring creates 6-month productivity gap, agent SKU rollout missed Q3 2026 commercial milestones because Datagrid integration is more complex than disclosed, and Courtemanche-Executive-Chairman dynamic produces public board friction that pressures stock. Q4 2026 earnings miss + guidance cut triggers multiple compression to peer SaaS levels.
...
→ **CLOSE if**: Davis is replaced as CEO within 18 months of appointment (signals founder-operator transition failure mode).
