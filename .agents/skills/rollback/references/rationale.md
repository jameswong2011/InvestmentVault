...
Tier B Log entries cannot be auto-reverted — they are append-only per AGENTS.md Tier 2. Three user options exist:
- **Surface only**: leave as historical audit trail (preferred per AGENTS.md convention)
