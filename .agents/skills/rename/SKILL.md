...
**Word cap**: after edits, check `_hot.md` total. Over 4,000 (soft cap per `.agents/skills/_shared/hot-md-contract.md`; unlikely from rename) → prune `## Sync Archive` oldest first. Abort if over 5,000 hard cap.
