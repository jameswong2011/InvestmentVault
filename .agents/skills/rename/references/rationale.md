...
The `.agents/skills/_shared/wikilink-forms.md` contract defines 5 canonical forms. `$rename` includes 2 additional archive-specific forms (`[[_Archive/TICKER - OldName]]` and `[[_Archive/TICKER - OldName.md]]`) because:
