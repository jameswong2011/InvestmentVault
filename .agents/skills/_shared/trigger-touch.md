...
- **Auto-executing `$status`.** A trigger touch is a flag, never an action. Conviction/status changes are Tier-3 (AGENTS.md) — human-confirmed. The check surfaces; the user decides.
