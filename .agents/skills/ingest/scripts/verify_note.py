...
def main():
    ...
    # Per .agents/skills/_shared/provenance-tags.md: Evidence figures should carry a terse source tag
        ...
        if ev:
            ...
            if high_prec and not prov_tag:
                soft_fail.append(
                    ...
                    "precision may exceed sourcing; tag per .agents/skills/_shared/provenance-tags.md (review; not blocked)")
