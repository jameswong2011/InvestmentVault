...
- Human-facing vocabulary is more natural than `error` (which implies the assistant was wrong, not just disputed). "warning" captures the user's intent in most cases — "I'm flagging this as contestable" rather than "this is incorrect."
