...
- [[Theses/6981 - Murata Manufacturing]] (ticker-scoped, thesis-as-source): the 2026-05-28 demand-led AI-MLCC forecast adds MLCC-specific texture to the §Value chain Layer 6 passives row and §Affected vault theses Murata row. (1) **Per-rack MLCC economics** — 800VDC up-mixes the demand *profile* toward higher-V (250-1000V) / 008004 / auto-grade parts → ~3.2× Murata MLCC revenue per 800VDC rack vs a traditional AI rack; the intuitive 2-3× content × 3-5× price = 6-15× double-counts (the premium hits incremental units only, and the 3-5× is vs commodity parts an AI rack already exceeds). (2) **2027-29 small-case MLCC shortage** — capex lands ~18-24mo behind the FY28-30 demand inflection, so MLCC supply gaps in 2027-29 (2018-style ASP/OPM overshoot, partial give-back FY30-31); a new entry for the bottleneck-cascade / inflection-points timing alongside the existing nanocrystalline-core + ≥3.3 kV SiC-module bottlenecks. (3) **Demand-led endpoint** — AI-MLCC ~43% of Murata sales / ~62% of OP by FY35, capex-gated (~¥550-700B/yr FY28-32 vs ~24% supply-capped). Conviction impact: unchanged for the macro framework (sharpens the MLCC layer's revenue/timing detail; the 800VDC adoption curve itself is unchanged).

### 2026-05-29 (/sync)
- [[Research/2026-05-29 - Earnings Transcripts vs Thesis - 6 Holdings - synthesis]]: macro-micro check on the GaN-epi gate — Aixtron (Feb 2026 FY25 call) says the 800V GaN ramp is "not there yet," a '27–'29 cycle; the epi-tool order pull (leading indicator) has not yet fired, putting GaN-on-Si 800VDC capacity at the later end of the base-case 2027 inflection (forecast curve unchanged). Murata confirmed 800V→50V→GPU architecture. Conviction unchanged at the macro-link level.

### 2026-06-05 (/sync)
- [[Research/2026-06-05 - AI-Grade MLCC Upstream Pricing Power - deep-dive]]: supply-side micro-research extends the §Value chain map "under-priced oligopolies" framework one layer below Layer 6 — added the MLCC merchant-materials sub-layer (release film / BaTiO₃ / Ni powder), same bottleneck-cascade signature as the nanocrystalline-core SST choke point, plus the investability paradox (most acute bottleneck = least concentrated equity). Adoption-curve framework unchanged; sharpens the upstream-passives layer. Conviction unchanged at macro-link level.
